  ...
  return (
    <div className={cn('flex w-full gap-3 py-2', isUser ? 'justify-end' : 'justify-start')}>
      ...
      <div className={cn(
        ...
        <div className={cn(
          'w-full min-w-0 overflow-hidden px-4 py-3 text-sm leading-relaxed shadow-sm',
          isUser
            ? 'rounded-2xl rounded-tr-sm bg-primary text-primary-foreground'
            : 'rounded-2xl rounded-tl-sm border border-border/60 bg-card/80 text-foreground/90',
        )}>
          {isUser
